    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-3 bg-gray-900/60 hover:bg-gray-800/60 border-2 border-electric-blue-500/30 rounded-xl px-4 py-3 text-white transition-all duration-300 hover:border-electric-blue-500/60 min-w-[200px]"
            >
                <span className="text-xl">{currentEnvInfo.icon}</span>
                <div className="flex-1 text-left">
                    <div className="font-medium text-electric-blue-400">{currentEnvInfo.name}</div>
            ...
            {isOpen && (
                <div className="absolute top-full left-0 mt-2 w-full bg-gray-900/95 backdrop-blur-sm border-2 border-electric-blue-500/30 rounded-xl shadow-lg z-50">
                    <div className="p-2">
                        <div className="text-xs text-electric-blue-400 px-3 py-2 font-medium">
